...
layui.config({
	...
	var form = layui.form(),
		...
		tab = layui.bodyTab({
			...
			url : "/admin/get_nav_menu/" //获取菜单json地址
		});
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="/static/style/images/face.jpg"/></div>'+
							'<div class="admin-header-lock-name" id="lockUserName">请叫我翌哥</div>'+
							'<div class="input_btn">'+
